...
public:
  ...
  typedef ProjectOption ZilchSelf;
...
public:
  /// Needed to connect to events.
  typedef ProjectTabArea ZilchSelf;
...
public:
  /// Needed to connect to events.
  typedef RecentProject ZilchSelf;
...
public:
  /// Needed to connect to events.
  typedef ProjectDialog ZilchSelf;
